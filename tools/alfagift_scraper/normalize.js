...
/**
 * Turns a raw Alfagift API product object into the flat shape the tideview
 * shop needs: { sku, name, imageUrl, price, priceOriginal, unit, available, raw }.
 *
 * Alfagift is a live third-party site and can rename its JSON fields at any
